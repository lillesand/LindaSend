...
[![Build Status](https://travis-ci.org/AndroidBootstrap/no-jvl-lindasend.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/no-jvl-lindasend)

This repository contains the source code for the [LindaSend](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=no.jvl.lindasend).

Please see the [issues](https://github.no.jvl.lindasend/no-jvl-lindasend/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about LindaSend? Ask away on the [no-jvl-lindasend discussion forum](https://groups.google.com/forum/#!forum/no-jvl-lindasend).

<a href="https://play.google.com/store/apps/details?id=no.jvl.lindasend" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __no.jvl.lindasend__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____no.jvl.lindasend__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.no.jvl.lindasend.R__) will now be renamed
...
signed with a different key.  Manually uninstall LindaSend from your device and
...
LindaSend is a result of a template project I've developed over the years as well as
...
LindaSend is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.no.jvl.lindasend/no-jvl-lindasend/contributors) on
...
[pull requests](https://github.no.jvl.lindasend/no-jvl-lindasend/pulls).
