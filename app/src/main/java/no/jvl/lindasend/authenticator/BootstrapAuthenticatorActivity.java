...
import no.jvl.lindasend.Injector;
import no.jvl.lindasend.R;
import no.jvl.lindasend.R.id;
import no.jvl.lindasend.R.layout;
import no.jvl.lindasend.R.string;
import no.jvl.lindasend.core.BootstrapService;
import no.jvl.lindasend.core.Constants;
import no.jvl.lindasend.core.User;
import no.jvl.lindasend.events.UnAuthorizedErrorEvent;
import no.jvl.lindasend.ui.TextWatcherAdapter;
