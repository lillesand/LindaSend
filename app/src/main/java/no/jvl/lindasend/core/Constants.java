...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "no.jvl.lindasend";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "LindaSend";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "no.jvl.lindasend.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "no.jvl.lindasend.";
